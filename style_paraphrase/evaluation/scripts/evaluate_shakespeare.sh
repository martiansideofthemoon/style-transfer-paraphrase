...
do
    ...
    path1=$2/eval_${gtype}_${top_p}/transfer_shakespeare_${split}.txt
    ...
    cat datasets/shakespeare/raw/${split}_1.attr datasets/shakespeare/raw/${split}_0.attr > ${base_path0}/all_${split}_transfer_labels.txt
