...
@register_task('sentence_prediction_cnn')
class SentencePredictionCNNTask(FairseqTask):
    """
    ...
    def add_args(parser):
        ...
        parser.add_argument('--cnn-kernel-size', type=int, default=5,
                            help='Size of the CNN kernel for convolution')
        parser.add_argument('--include-vectors', type=str, default="content",
                            help='Truncate sequence to max_sequence_length')
    ...
    def setup_task(cls, args, **kwargs):
        ...
        return SentencePredictionCNNTask(args, data_dict, label_dict)
    ...
    def build_model(self, args):
        ...
        model.register_sequence_classification_head(
            'sequence_classification_head_cnn_probe',
