...
@register_task('lm_probe_frozen')
class LMProbeFrozenTask(FairseqTask):
    """
    ...
    def add_args(parser):
        ...
        parser.add_argument('--probe-features', type=str, default="style,content",
                            help='List of input features for the probe')
    ...
    def setup_task(cls, args, **kwargs):
        ...
        return LMProbeFrozenTask(args, data_dict, label_dict)
