...
* Outputs from baselines for Shakespeare have been added to the Google Drive link. Please see [`style_paraphrase/evaluation/README.md`](style_paraphrase/evaluation/README.md) for a script to run evaluation on baselines.
